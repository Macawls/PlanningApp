...
@HiltViewModel
class TimeSheetsListByCategoryViewModel @Inject constructor(
    private val timesheetRepository: TimesheetRepository,
    private val savedStateHandle: SavedStateHandle
) : ViewModel() {

    private val _categoryId: String = savedStateHandle.get<String>("id")!!
    ...
    private fun getTimesheets(){
        viewModelScope.launch {
            val timesheetDtos = timesheetRepository
                .getTimesheetsFromCategory(categoryID = _categoryId)
